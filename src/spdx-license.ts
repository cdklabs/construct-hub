...
export class SpdxLicense {
   ...
   * @see undefined
   */
  public static readonly ALGLIB_DOCUMENTATION = new SpdxLicense('ALGLIB-Documentation');
   ...
   *
   * @see https://math.nist.gov/tnt/download.html
   */
  public static readonly NIST_PD_TNT = new SpdxLicense('NIST-PD-TNT');
   ...
   *
   * @see https://ftp.gnu.org/gnu/aspell/dict/en/aspell6-en-2020.12.07-0.tar.bz2
   */
  public static readonly BSD_MARK_MODIFICATIONS = new SpdxLicense('BSD-Mark-Modifications');
   ...
   *
   * @see https://gitlab.freedesktop.org/xorg/lib/libxinerama/-/blob/cc22c2f60c3862482562955116d5455263b443dc/COPYING#L44-66
   */
  public static readonly X11_NO_PERMIT_PERSONS = new SpdxLicense('X11-no-permit-persons');
   ...
   * OSSP License
   *
   * @see https://git.sr.ht/~nabijaczleweli/ossp-var
   */
  public static readonly OSSP = new SpdxLicense('OSSP');
   ...
   * MIT-STK License
   *
   * @see https://github.com/thestk/stk/blob/6aacd357d76250bb7da2b1ddf675651828784bbc/LICENSE
   */
  public static readonly MIT_STK = new SpdxLicense('MIT-STK');
   ...
   *
   * @see https://gitlab.com/agmartin/linuxdoc-tools/-/blob/master/iso-entities/COPYING?ref_type=heads
   */
  public static readonly ISO_PERMISSION = new SpdxLicense('ISO-permission');
   ...
   * UnRAR License
   *
   * @see https://public.dhe.ibm.com/aix/freeSoftware/aixtoolbox/LICENSES/unRAR.txt
   */
  public static readonly UN_RA_R = new SpdxLicense('UnRAR');
   ...
   *
   * @see https://essr.esa.int/license/european-space-agency-public-license-v2-4-weak-copyleft-type-2
   */
  public static readonly ESA_PL_WEAK_COPYLEFT_2_4 = new SpdxLicense('ESA-PL-weak-copyleft-2.4');
   ...
   */
  public static readonly WORD_NET = new SpdxLicense('WordNet');
   ...
   * Buddy License
   *
   * @see https://sourceforge.net/p/buddy/gitcode/ci/master/tree/README
   */
  public static readonly BUDDY = new SpdxLicense('Buddy');
   ...
   * @osiApproved
   *
   * @see https://opensource.org/license/osc-license-1-0
   */
  public static readonly OSC_1_0 = new SpdxLicense('OSC-1.0');
   ...
   *
   * @see https://github.com/BuildCraft/BuildCraft/blob/623d323b1868712f29f4a8b0979a02e8d1835131/LICENSE
   */
  public static readonly MMPL_1_0_1 = new SpdxLicense('MMPL-1.0.1');
   ...
   *
   * @see https://essr.esa.int/license/european-space-agency-public-license-v2-4-permissive-type-3
   */
  public static readonly ESA_PL_PERMISSIVE_2_4 = new SpdxLicense('ESA-PL-permissive-2.4');
   ...
   *
   * @see https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/hyphen-bulgarian.tar.xz
   */
  public static readonly HYPHEN_BULGARIAN = new SpdxLicense('hyphen-bulgarian');
   ...
   *
   * @see https://docs.python.org/3/license.html#execution-tracing
   */
  public static readonly HPND_SMC = new SpdxLicense('HPND-SMC');
   ...
   *
   * @see https://essr.esa.int/license/european-space-agency-public-license-v2-4-strong-copyleft-type-1
   */
  public static readonly ESA_PL_STRONG_COPYLEFT_2_4 = new SpdxLicense('ESA-PL-strong-copyleft-2.4');
   ...
   * @see https://ftp.gnu.org/gnu/aspell/dict/en/aspell6-en-2020.12.07-0.tar.bz2
   */
  public static readonly ADVANCED_CRYPTICS_DICTIONARY = new SpdxLicense('Advanced-Cryptics-Dictionary');
   ...
   * Vixie Cron License
   *
   * @see https://github.com/vixie/cron/tree/545b3f5246824a9cda5905eeb7cf019c95e66995
   */
  public static readonly VIXIE_CRON = new SpdxLicense('Vixie-Cron');
   ...
   * TekHVC License
   *
   * @see https://gitlab.freedesktop.org/xorg/lib/libx11/-/blob/master/COPYING?ref_type=heads#L138-171
   */
  public static readonly TEK_HV_C = new SpdxLicense('TekHVC');
   ...
   *
   * @see https://github.com/adversary-org/wtfnmf/raw/refs/tags/1.0/COPYING.WTFNMFPL
   */
  public static readonly WTFNMFPL = new SpdxLicense('WTFNMFPL');
   ...
   *
   * @see https://blitiri.com.ar/p/bola/
   */
  public static readonly BOLA_1_1 = new SpdxLicense('BOLA-1.1');
   ...
   *
   * @see https://capec.mitre.org/about/termsofuse.html
   */
  public static readonly CAPEC_TOU = new SpdxLicense('CAPEC-tou');
   ...
   *
   * @see https://web.archive.org/web/20161209023955/http://www.paratype.ru/public/pt_openlicense_eng.asp
   */
  public static readonly PARATYPE_FREE_FONT_1_3 = new SpdxLicense('ParaType-Free-Font-1.3');
   ...
   *
   * @see https://gitweb.gentoo.org/repo/gentoo.git/tree/licenses/SGMLUG?id=7d999af4a47bf55e53e54713d98d145f935935c1
   */
  public static readonly SGMLUG_PM = new SpdxLicense('SGMLUG-PM');
   ...
   *
   * @see https://www.x.org/archive/current/doc/xorg-docs/License.html#Theodore_Tso
   */
  public static readonly BSD_3_CLAUSE_TSO = new SpdxLicense('BSD-3-Clause-Tso');
   ...
   *
   * @see https://gitlab.freedesktop.org/xorg/driver/xf86-video-voodoo/-/blob/68a5b6d98ae34749cca889f4373b4043d00bfe6a/src/voodoo_dga.c#L12-33
   */
  public static readonly HPND_SELL_VARIANT_CRITICAL_SYSTEMS = new SpdxLicense('HPND-sell-variant-critical-systems');
   ...
   *
   * @see https://raw.githubusercontent.com/OpenMDW/OpenMDW/refs/heads/main/1.0/LICENSE.openmdw
   */
  public static readonly OPENMDW_1_0 = new SpdxLicense('OpenMDW-1.0');
  ...
  public static osiApproved(): SpdxLicense[] {
    return [
      ...
      SpdxLicense.ALGLIB_DOCUMENTATION,
      SpdxLicense.AAL,
      SpdxLicense.VSL_1_0,
  ...
  public static bsd(): SpdxLicense[] {
    return [
      ...
      SpdxLicense.BSD_MARK_MODIFICATIONS,
