...
// src/backend/deny-list/prune-handler.lambda.ts
var prune_handler_lambda_exports = {};
__export(prune_handler_lambda_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(prune_handler_lambda_exports);
var import_aws_embedded_metrics = __toESM(require_lib());

// src/backend/deny-list/constants.ts
var ENV_DENY_LIST_BUCKET_NAME = "DENY_LIST_BUCKET_NAME";
var ENV_DENY_LIST_OBJECT_KEY = "DENY_LIST_OBJECT_KEY";
var ENV_PRUNE_PACKAGE_DATA_BUCKET_NAME = "PACKAGE_DATA_BUCKET_NAME";
var ENV_PRUNE_PACKAGE_DATA_KEY_PREFIX = "PACKAGE_DATA_KEY_PREFIX";
var ENV_PRUNE_QUEUE_URL = "PRUNE_QUEUE_URL";
var ENV_PRUNE_ON_CHANGE_FUNCTION_NAME = "ON_CHANGE_FUNCTION_NAME";
var METRICS_NAMESPACE = "ConstructHub/DenyList";

// src/backend/shared/aws.lambda-shared.ts
var _AWS = __toESM(require("aws-sdk"));
var AWSXRay = __toESM(require_lib2());
AWSXRay.setContextMissingStrategy(() => {
});
var AWS = AWSXRay.captureAWS(_AWS);
var _s3;
var _sqs;
var _lambda;
function s3() {
...
// src/backend/deny-list/client.lambda-shared.ts
var DenyListClient = class _DenyListClient {
  /**
   * Creates a new client for accessing the deny list.
   */
  static async newClient() {
    const client = new _DenyListClient();
    await client.init();
    return client;
  }
  constructor() {
...
async function handler(event) {
  ...
  await (0, import_aws_embedded_metrics.metricScope)((metrics) => async () => {
    ...
    metrics.putMetric("DenyListRuleCount" /* DENY_LIST_RULE_COUNT */, ruleCount, import_aws_embedded_metrics.Unit.Count);
  })();
  ...
  for (const nameVersion of Object.keys(client.map)) {
    ...
    do {
      ...
      const result = await s32.listObjectsV2(req).promise();
      ...
      for (const object of result.Contents ?? []) {
        ...
        const sendMessageResponse = await sqs2.sendMessage(sendMessageRequest).promise();
    ...
    if (onChangeFunctionName && objectsFound.length > 0) {
      ...
      const onChangeCallbackResponse = await lambda2.invoke(onChangeCallbackRequest).promise();
