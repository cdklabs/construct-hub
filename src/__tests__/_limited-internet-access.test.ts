...
import { parsePrefixList, createRestrictedSecurityGroups } from '../_limited-internet-access';
...
describe(parsePrefixList, () => {
  const mockReadFileSync = jest.fn().mockName('fs.readFileSync') as jest.MockedFunction<typeof fs.readFileSync>;
  beforeEach(() => {
