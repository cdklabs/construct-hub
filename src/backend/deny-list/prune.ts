...
export class Prune extends Construct {
  ...
  constructor(scope: Construct, id: string, props: PruneProps) {
    ...
    props.onCallDashBoard.addConcurrentExecutionMetricToOnCallDashboard(this.pruneHandler);
    props.onCallDashBoard.addConcurrentExecutionMetricToOnCallDashboard(this.deleteHandler);
  }
