...
export class Orchestration extends Construct {
  ...
  public constructor(scope: Construct, id: string, props: OrchestrationProps) {
    ...
    props.onCallDashboard.addDLQMetricToOnCallDashboard('Orchestration DLQ', this.deadLetterQueue, this.redriveFunction);
    ...
    props.onCallDashboard.addConcurrentExecutionMetricToOnCallDashboard(needsCatalogUpdateFunction);
  }
