...
export class CodeArtifact implements IPackageSource {
  ...
  public bind(
    ...
    onCallDashboard.addDLQMetricToOnCallDashboard(`CodeArtifact/${repositoryId} DLQ`, dlq);
    onCallDashboard.addConcurrentExecutionMetricToOnCallDashboard(forwarder);
