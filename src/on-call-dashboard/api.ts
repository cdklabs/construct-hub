 ...
 */
export interface IOnCallDashboard {
  /**
   ...
   */
  addDLQMetricToOnCallDashboard(name: string, deadLetterQueue: IQueue, reDriveFunction?: IFunction): void;
   ...
   */
  addConcurrentExecutionMetricToOnCallDashboard(fn: IFunction): void;
